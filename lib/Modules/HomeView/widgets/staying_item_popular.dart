...
import 'book_hotel_staying.dart';
class  StayaingItem extends StatelessWidget {
  StayaingItem({Key? key,required this.image}) : super(key: key);
  String image;
  @override
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=>const BookHotelStaying()));
                },
                child: Container(
                  decoration: BoxDecoration(
